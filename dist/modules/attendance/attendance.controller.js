...
let AttendanceController = class AttendanceController {
    ...
    async createRecord(dto) {
        console.log('Incoming POST /attendance request:', JSON.stringify(dto));
        return this.attendanceService.createRecord(dto);
    }
    async processLogs(body) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AttendanceController.prototype, "listRecordsLegacy", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AttendanceController.prototype, "processLogs", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AttendanceController.prototype, "deleteRecord", null);
